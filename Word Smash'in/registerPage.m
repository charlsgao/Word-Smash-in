...
- (void)viewDidLoad
{
    ...
    self.errCode = [NSDictionary dictionaryWithObjectsAndKeys:
                    @"Username is exists. Please try another username.", [NSNumber numberWithInt:ERR_USER_EXISTS],
                    @"Username/Password must be between 4 to 16 letters. Please try again.",  [NSNumber numberWithInt:ERR_BAD_INPUT],
                    @"Email format is incorrect. Please try again.",  [NSNumber numberWithInt:ERR_BAD_EMAIL],
                    nil];
