...
- (void)viewDidLoad
{
    ...
    self.errCode = [NSDictionary dictionaryWithObjectsAndKeys:
                    @"Email field cannot be empty. Please input your Email.", [NSNumber numberWithInt:ERR_EMAIL_EMPTY],
                    @"Email does not exist. Please try again.",  [NSNumber numberWithInt:ERR_EMAIL_NOT_EXISTS],
                    nil];
...
// This method will change the username's atrribute with the text entered to Email's Field
